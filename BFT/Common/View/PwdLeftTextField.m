...
- (id)initWithFrame:(CGRect)frame left:(NSString*)leftStr prompt:(NSString*)prompt
{
    ...
    if (self) {
        ...
        UIImageView *confirmPWDbg = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, self.frame.size.width, self.frame.size.height)];
        [confirmPWDbg setImage:[UIImage imageNamed:@"textInput.png"]];
        [self addSubview:confirmPWDbg];
        UIImageView *confirmpassword = [[UIImageView alloc] initWithFrame:CGRectMake(15, 10, 22, 25)];
        [confirmpassword setImage:[UIImage imageNamed:@"password.png"]];
        ...
        if (DeviceVersion >= 7)
        {
            self.pwdTF = [[UITextField alloc] initWithFrame:CGRectMake(60, 2, frame.size.width-40, frame.size.height)];
        }
        else
        {
            self.pwdTF = [[UITextField alloc] initWithFrame:CGRectMake(60, 11, frame.size.width-40, frame.size.height)];
        }
