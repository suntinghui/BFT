...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        pwdTF = [[UITextField alloc] initWithFrame:CGRectMake(10, 9, frame.size.width, frame.size.height)];
...
{
    NSString *mess = [NSString stringWithFormat:@"%@为保护您的密码安全，请您使用定制的键盘输入密码。密码键盘每次随机打乱按键顺序，并且在您输入完6位密码后自动对密码进行加密，全面保护您的账户安全。",@"佰付通"];
